...
# Configuración de SQLite para persistencia real
...
def create_account():
    if request.method == 'POST':
        ...
        new_user.set_password(password)  # Guarda el hash
...
def page_not_found(e):
    return render_template('404.html', background_class='forgot-password-background'), 404
